...
ALTER TABLE "rx_cases" ALTER COLUMN "ship_to" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "rx_cases" ALTER COLUMN "form_data" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "rx_cases" ALTER COLUMN "device_options" SET DATA TYPE text;--> statement-breakpoint
