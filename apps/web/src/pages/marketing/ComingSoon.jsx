    ...
    <div>
      ...
      <section className="relative bg-gradient-to-b from-diamond-300 via-brand-500 to-surface-100 pt-32 pb-28">
        <div className="section-pad text-center max-w-2xl mx-auto">
          <div className="w-14 h-14 rounded-2xl bg-white/10 border border-white/10 flex items-center justify-center mx-auto mb-6">
            <Clock size={24} className="text-ink/50" />
          </div>
      ...
      <section className="relative z-10 section-pad -mt-8 pb-20">
        <div className="max-w-lg mx-auto text-center">
          <div className="bg-white card-radius p-10 border border-surface-300/50 shadow-xl shadow-ink/5">
            ...
            <div className="flex items-center justify-center gap-3">
              <Link
                to="/"
                className="flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium border border-surface-300/50 text-ink/60 hover:text-ink hover:border-brand-500/30 transition-all"
              >
