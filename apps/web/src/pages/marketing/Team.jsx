...
function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative h-[70dvh] min-h-[500px] flex items-end overflow-hidden bg-gradient-to-b from-navy via-navy-light to-navy"
    >
...
function StatBar() {
  ...
  return (
    <section ref={ref} className="section-pad py-16 md:py-20 bg-navy">
