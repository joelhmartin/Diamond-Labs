    ...
    <div>
      ...
      <section className="relative bg-gradient-to-b from-diamond-300 via-brand-500 to-surface-100 pt-32 pb-28">
        <div className="section-pad text-center max-w-2xl mx-auto">
          ...
          <h1 className="mt-4 font-heading font-bold text-3xl md:text-5xl text-ink tracking-tight">
            Downloads
          </h1>
          <p className="mt-4 text-ink/40 text-sm md:text-base max-w-md mx-auto leading-relaxed">
      ...
      <section className="relative z-10 section-pad -mt-8 pb-20">
        <div className="max-w-3xl mx-auto space-y-4">
          {downloads.map((item) => (
            <a
              ...
              download
              className="group flex items-center gap-5 bg-white card-radius p-6 border border-surface-300/50 shadow-lg shadow-ink/5 hover:border-brand-500/30 hover:shadow-xl transition-all"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-ink/40 text-xs md:text-sm mt-0.5 line-clamp-1">
                  {item.description}
                </p>
                <div className="flex items-center gap-2 mt-1">
                  <span className="inline-block px-2 py-0.5 rounded-full bg-surface-100 text-ink/30 text-[10px] font-mono uppercase tracking-wider">
                    {item.category}
                  </span>
                  <span className="text-ink/20 text-[10px] font-mono">{item.year}</span>
                </div>
              </div>
        ...
        <div className="max-w-3xl mx-auto mt-10 text-center">
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium border border-surface-300/50 text-ink/60 hover:text-ink hover:border-brand-500/30 transition-all"
          >
