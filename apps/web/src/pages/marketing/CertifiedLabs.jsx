...
function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative h-[75dvh] min-h-[520px] flex items-end overflow-hidden bg-navy"
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-navy via-navy/70 to-navy/40" />
