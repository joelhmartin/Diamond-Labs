...
import { Search, RefreshCw, Undo2, Loader2, AlertCircle } from "lucide-react";
      ...
      <div className="mt-6 overflow-hidden rounded-2xl border border-surface-300/40 bg-white">
        {loading ? (
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {payments.map((p) => (
                <tr key={p.transactionId} className="border-t border-surface-300/30 hover:bg-surface-50/50">
