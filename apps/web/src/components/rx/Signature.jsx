    ...
    <div>
      ...
      <div className="relative rounded-2xl bg-surface-50 border border-surface-300/50 overflow-hidden">
        ...
        <div className="absolute bottom-2 left-0 right-0 flex items-center justify-between px-3">
          <span className="text-[10px] font-mono text-muted">X</span>
          {hasInk && (
            <button
              type="button"
              onClick={clear}
              className="flex items-center gap-1 text-[10px] font-mono text-secondary hover:text-accent-500 transition-colors px-2 py-1 rounded-full bg-white/60 backdrop-blur-sm"
            >
              <Eraser size={10} />
              Clear
            </button>
