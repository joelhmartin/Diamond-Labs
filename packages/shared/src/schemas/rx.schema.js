 ...
 * (POST /rx/form-submissions). This intake-only form (digital — ortho folds
 * in as a gated device rather than a separate formType) carries all of its
 * answers in a free-form `formData` object rather
